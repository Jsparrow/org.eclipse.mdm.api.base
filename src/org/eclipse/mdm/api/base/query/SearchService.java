...
public interface SearchService {
	...
	/**
	 * Returns all entities supported by the {@link SearchQuery} associated
	 ...
	 */
	List<Entity> listEntities(Class<? extends DataItem> type);

	/**
	 * Returns the {@link Searchable}, which describes a hierarchical order of
	 * the entities supported by the {@link SearchQuery} associated with given
	 * {@link DataItem} type.
	 *
	 * @param type Used as identifier.
	 ...
	 * @see #listEntities(Class)
	 */
	List<Value> getFilterValues(Class<? extends DataItem> type, Attribute attribute, Filter filter)
			throws DataAccessException;

	/**
	 * Executes the associated {@link SearchQuery} with given entities and
	 * passed {@link Filter}. Both must be fully supported by the {@code
	 ...
	 */
	<T extends DataItem> Map<T, List<Record>> fetchComplete(Class<T> type, List<Entity> entities, Filter filter)
			throws DataAccessException;
